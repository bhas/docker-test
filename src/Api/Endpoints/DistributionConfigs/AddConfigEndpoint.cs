...
public class AddConfigEndpoint(IDistributionConfigRepository distributionConfigRepository) : Endpoint<AddConfigEndpoint.Request, DistributionConfigDto>
{
